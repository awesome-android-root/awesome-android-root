...
head:
  - - link
    - rel: canonical
      href: https://awesome-android-root.pages.dev/general-guides/bootloader-mods-and-temp-root
  - - meta
    - name: author
  ...
  - - meta
    - property: og:url
      content: https://awesome-android-root.pages.dev/general-guides/bootloader-mods-and-temp-root
  - - meta
    - property: og:locale
      content: en_US
  - - meta
