...
head:
  - - link
    - rel: canonical
      href: https://hawesome-android-root.zhoe.org/rooting-guides/apatch-guide
  - - meta
    - property: og:type
      content: article
  - - meta
  ...
  - - meta
    - property: og:url
      content: https://hawesome-android-root.zhoe.org/rooting-guides/apatch-guide
  - - meta
    - property: og:image
      content: https://hawesome-android-root.zhoe.org/images/og/apatch-guide.png
  - - meta
    - name: twitter:card
